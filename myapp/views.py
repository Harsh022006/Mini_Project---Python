...
def contact(request):
    if request.method=="POST":
        ...
        conatcts=Contact.objects.all().order_by("-id")[:3]
        return render(request,'contact.html',{'msg':msg,'contacts':conatcts})
    else:
        conatcts=Contact.objects.all().order_by("-id")[:3]
        return render(request,'contact.html',{'contacts':conatcts})
    ...
    if request.method=="POST":
        ...
        if user.password==request.POST['old_password']:
            if request.POST['new_password']==request.POST['cnew_password']:
                ...
                msg="Your New Password and Confirm New Password Doesn't Matched"
                return render(request,'change-password.html',{'msg':msg})
        else:
